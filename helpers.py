...
NFFT = 512
nfilt = 40
sample_rate = 8000 #TODO: find actual rate

def pre_emphasis(signal):
    return np.append(signal[0], signal[1:] - signal[:-1]*.97)
...
def get_filter_bank(signal):
    emphasized_signal = pre_emphasis(signal)
    pow_frames = get_frames(emphasized_signal)
